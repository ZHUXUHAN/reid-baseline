...
for file in query_files:
    ...
    file_front = file.split('_')[0]
    query_newname = file.replace(file_front, str(query_newid))
    print(query_newname)
...
for file in gallery_files:
    ...
    file_front = file.split('_')[0]
    gallery_newname = file.replace(file_front, str(gallery_newid))
    print(gallery_newname)
