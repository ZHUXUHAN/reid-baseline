...
_C.MODEL.ALIGNED = False

_C.MODEL.PCB = False

_C.MODEL.PCB_NUM_STRIPES = 6

_C.MODEL.WITH_GCB = False

_C.MODEL.PCB_RPP = False
...
_C.TEST.ADJUST_RERANK = False

_C.TEST.GLOBAL_LOCAL =False

_C.TEST.GLOBAL = False

_C.TEST.SAVE_DIST_QG = './test_dist/qg'

_C.TEST.SAVE_DIST_QQ = './test_dist/qq'
