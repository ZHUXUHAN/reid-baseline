...
import torch.nn as nn
from .switchwhiten2d import SwitchWhiten2d

__all__ = ['resnet18_sw', 'resnet34_sw', 'resnet50_sw', 'resnet101_sw',
           'resnet152_sw']
...
class ResNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 layers,
                 num_classes=1000,
                 norm_cfg=dict(type='SW', requires_grad=True),
                 sw_cfg=None,
    ...
    def load_param(self, model_path):
        ...
        for i in param_dict:
            if 'fc' in i:
                continue
            self.state_dict()[i[7:]] = param_dict[i].clone()


def resnet18_sw(pretrained=False, **kwargs):
...
def resnet34_sw(pretrained=False, **kwargs):
...
def resnet50_sw(last_stride, pretrained=False, **kwargs):
...
def resnet101_sw(pretrained=False, **kwargs):
...
def resnet152_sw(pretrained=False, **kwargs):
