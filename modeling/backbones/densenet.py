...
class DenseNet(nn.Module):
    ...
    def __init__(self,  loss, growth_rate=32, block_config=(6, 12, 24, 16),
                 num_init_features=64, bn_size=4, drop_rate=0, fc_dims=None, dropout_p=None, **kwargs): #num_classes,
...
def densenet121(num_classes, loss='softmax', pretrained=False, **kwargs):
    model = DenseNet(
...
def densenet169(num_classes, loss='softmax', pretrained=False, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        loss=loss,
        num_init_features=64,
...
def densenet201(num_classes, loss='softmax', pretrained=False, **kwargs):
    model = DenseNet(
        num_classes=num_classes,
        loss=loss,
        num_init_features=64,
...
def densenet161(loss='softmax', pretrained=False, **kwargs):
    model = DenseNet(
        loss=loss,
